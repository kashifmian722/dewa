...
namespace Appflix\DewaShop\Core\Content\Shop\Aggregate\ShopSalesChannel;
...
class ShopSalesChannelDefinition extends MappingEntityDefinition
{
    public const ENTITY_NAME = 'dewa_shop_sales_channel';
